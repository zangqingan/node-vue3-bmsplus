...
export class SysRoleEntity extends BaseEntity {
  ...
  @Column({ type: 'varchar', name: 'role_name', nullable: false, length: 30, comment: '角色名称' })
  roleName: string;

  @Column({ type: 'varchar', name: 'role_key', nullable: false, length: 100, comment: '角色权限字符串' })
  roleKey: string;

  @Column({ type: 'int', name: 'role_sort', nullable: false, default: 0, comment: '显示顺序' })
  roleSort: number;
