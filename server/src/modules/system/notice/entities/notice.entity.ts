...
export class SysNoticeEntity extends BaseEntity {
  ...
  @Column({ type: 'varchar', name: 'notice_title', length: 50, nullable: false, default: '', comment: '公告标题' })
  noticeTitle: string;

  @Column({ type: 'char', name: 'notice_type', length: 1, nullable: false, comment: '公告类型(1通知 2公告)' })
  noticeType: string;
